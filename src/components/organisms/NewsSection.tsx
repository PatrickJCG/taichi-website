    ...
    <section id="news" className="relative py-20 bg-white border-b border-slate-200/60 overflow-hidden bg-grid-pattern">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <SectionHeader
          ...
          description="Stay informed on NutriPro's latest scientific breakthroughs, regulatory milestones, and global industry presence."
          className="mb-16"
        />
        ...
        <div className="flex justify-center mt-12">
          <Button
            ...
            className="group !text-brand-teal-700 hover:!bg-brand-teal-50 border border-brand-teal-200/60 hover:border-brand-teal-300"
          >
            View All Updates
          </Button>
        </div>
